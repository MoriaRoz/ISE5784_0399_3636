...
/**
 * Minip1: Anti-Aliasing
 */
public class Minip1 {

    /**
     * Creating the Rubik's cube scene with Anti-Aliasing
     */
    @Test
    public void Minip1() {
    ...
    @Test
    public void Minip1_1() {
        Scene scene = new Scene("Minip1_1");
        ...
        Camera.Builder camera = Camera.getBuilder()
                .setDirection(new Vector(-70,-70,-30), new Vector(-3,-3,14))
                .setRayTracer(new SimpleRayTracer(scene));
        ImageWriter imageWriter=new ImageWriter("Minip1_1", 900, 900);
        camera.setLocation(new Point(70, 70, 30))
                .setVpSize(100, 100)
                .setVpDistance(100)
                .setImageWriter(imageWriter)
                .setRayTracer(new SimpleRayTracer(scene))
                .build()
                .setAntiAliasingFactor(20) // Set 4x4 anti-aliasing
                .renderImage()
                .writeToImage();
    }
}
