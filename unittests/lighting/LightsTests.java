...
//   }
    ...
    /**
     * Test rendering a sphere with multiple light sources
     */
    @Test
    public void sphereMultipleLights() {
        scene1.geometries.add(new Sphere(50, new Point(0, 0, -100)) //
                .setEmission(new Color(java.awt.Color.BLUE)) //
                .setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(SHININESS)));

        scene1.lights.add(new PointLight(new Color(700, 400, 400), new Point(50, 50, 100)) //
                .setkL(0.0001).setkQ(0.00001));
        scene1.lights.add(new SpotLight(new Color(400, 700, 400), new Point(-50, -50, 50), new Vector(1, 1, -2)) //
                .setkL(0.0001).setkQ(0.00001));
        scene1.lights.add(new DirectionalLight(new Color(300, 300, 700), new Vector(0, 0, -1)));
    ...
    /**
     * Test rendering a pair of triangles with multiple light sources
     */
    @Test
    public void trianglesMultipleLights() {
        ...
        scene2.lights.add(new PointLight(new Color(700, 400, 400), new Point(40, 40, 115)) //
                .setkL(0.0001).setkQ(0.00001));
        scene2.lights.add(new SpotLight(new Color(400, 700, 400), new Point(-30, -30, 50), new Vector(1, 1, -2)) //
                .setkL(0.0001).setkQ(0.00001));
        scene2.lights.add(new DirectionalLight(new Color(300, 300, 700), new Vector(0, 0, -1)));
